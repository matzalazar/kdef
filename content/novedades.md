...
- álgebra i: hay una autoevaluación **obligatoria**.
- análisis i: hay una autoevaluación **obligatoria**.
- gestión de servicios: hay una autoevaluación.
- sistemas operativos i: hay una autoevaluación y dos actividades.
- inglés i: no hay actividades, pero muchos están usando el foro para publicar sus respuestas.
...
- gestión de servicios: hay una autoevaluación.
- sistemas operativos i: hay una autoevaluación.
- sistemas operativos i: hay actividades en el foro.
